...
## Overview
The design system SHALL document the dark mode color palette, surface hierarchy rules, and a checklist for new UI elements to ensure consistent and accessible dark mode implementation across the site.
